...
export class LocalDataSource extends DataSource {
   ...
   * @returns {LocalDataSource}
   */
  override setFilter(conf: Array<any>, andOperator = true, doEmit = true): LocalDataSource {
  ...
  override addFilter(fieldConf: any, andOperator = true, doEmit: boolean = true): LocalDataSource {
  ...
  override setPaging(page: number, perPage: number, doEmit: boolean = true): LocalDataSource {
